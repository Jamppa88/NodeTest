...
const ModListItem = (props) => {
  if (!props.rights) {
    ...
    return (
      <tr>
        <td className="align-middle"><input type="text" className="form-control form-control-sm modify-box" defaultValue={props.data.name} /></td>
        <td className="align-middle"><input type="number" className="form-control form-control-sm modify-box" style={{maxWidth: '4em'}} defaultValue={props.data.mod} /></td>
        <td className="align-middle">
          <select className="form-control form-control-sm modify-box" defaultValue={props.data.adv} >
